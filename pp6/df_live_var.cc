...
bool df_live_var::compute_gen_set(Instruction* node) { return false; }

bool df_live_var::compute_kill_set(Instruction* node) { return false; }

void df_live_var::init_in_set(Instruction* node) { }

void df_live_var::init_out_set(Instruction* node) { }

bool df_live_var::apply_meet_operator(Instruction* node) { return false; }

bool df_live_var::apply_transfer_function(Instruction* node) { return false; }
  
void df_live_var::status(Instruction* node, DF_STATUS_TYPE status) {}

DF_STATUS_TYPE df_live_var::status(Instruction* node) { return DF_NOT_INITIALIZED; }
