 ...
 */
typedef enum { 
    T_Plus = int('+'), T_Minus = int('-'), 
    T_Times = int('*'), T_Div = int('/'), 
    T_Mod = int('%'), T_Eq = int('='), 
    T_GreaterThan = int('>'), T_LessThan = int('<'),
    T_Not = int('!'), T_Colon = int(';'), 
    T_Dot = int('.'), T_Comma = int(','),
    T_OpenParenthesis = int('('), T_CloseParenthesis = int(')'),
    T_OpenBraces = int('['), T_CloseBraces = int(']'),
    T_OpenCurly = int('{'), T_CloseCurly = int('}'),
    T_Void = 256,
